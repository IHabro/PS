...
setwd("C:/Users/hab0065/Downloads/hab0065/WD_14")
...
addmargins(kont.tab)
round(100 * prop.table(kont.tab, 1), 0)
mosaicplot(kont.tab, color = c("red", "green", "blue"))
cramersV(kont.tab)
...
prop.test(65,108,alternative = "two.sided",conf.level = 0.95) # nutno upozornit na nesplnění předpokladů

prop.test(c(38,27),c(51,57),alternative = "greater",conf.level = 0.95) # nutno upozornit na nesplnění předpokladů
